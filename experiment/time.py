...
########################################################
user_time_legible_task1 = np.mean(np.concatenate([user_time_task1[:,:1], user_time_task1[:,3:]], axis=1), axis=1)
user_time_illegible_task1 = np.mean(np.concatenate([user_time_task1[:,1:2], user_time_task1[:,2:3]], axis=1), axis=1)

user_time_legible_task2 = np.mean(np.concatenate([user_time_task2[:,:1], user_time_task2[:,2:3]], axis=1), axis=1)
user_time_illegible_task2 = np.mean(np.concatenate([user_time_task2[:,1:2], user_time_task2[:,3:]], axis=1), axis=1)

# mean over users
mean_time_legible_task1 = np.mean(user_time_legible_task1)
mean_time_illegible_task1 = np.mean(user_time_illegible_task1)
mean_time_legible_task2 = np.mean(user_time_legible_task2)
mean_time_illegible_task2 = np.mean(user_time_illegible_task2)

# SEM over users
SEM_time_legible_task1 = np.std(user_time_legible_task1)/np.sqrt(users_n)
SEM_time_illegible_task1 = np.std(user_time_illegible_task1)/np.sqrt(users_n)
SEM_time_legible_task2 = np.std(user_time_legible_task2)/np.sqrt(users_n)
SEM_time_illegible_task2 = np.std(user_time_illegible_task2)/np.sqrt(users_n)
...
# mean
mean_legible = np.array([mean_time_legible_task1, mean_time_legible_task2])
mean_illegible = np.array([mean_time_illegible_task1, mean_time_illegible_task2])
# SEM
SEM_legible = np.array([SEM_time_legible_task1, SEM_time_legible_task2])
SEM_illegible = np.array([SEM_time_illegible_task1, SEM_time_illegible_task2])
plt.bar(X_axis - 0.2, mean_legible, yerr=SEM_legible, width=0.4, label = 'legible')
plt.bar(X_axis + 0.2, mean_illegible, yerr=SEM_illegible, width=0.4, label = 'illegible')
plt.xticks(X_axis, X)
