...
time_legible_task1 = np.array([mean_user_time_task1[0], mean_user_time_task1[3]])
time_illegible_task1 = np.array([mean_user_time_task1[1], mean_user_time_task1[2]])

avg_time_legible_task1 = np.mean(time_legible_task1)
avg_time_illegible_task1 = np.mean(time_illegible_task1)

time_legible_task2 = np.array([mean_user_time_task2[0], mean_user_time_task2[2]])
time_illegible_task2 = np.array([mean_user_time_task2[1], mean_user_time_task2[3]])

avg_time_legible_task2 = np.mean(time_legible_task2)
...
avg_legible = np.array([avg_time_legible_task1, avg_time_illegible_task2])
avg_illegible = np.array([avg_time_illegible_task1, avg_time_illegible_task2])
print(avg_legible, avg_illegible)
# x
