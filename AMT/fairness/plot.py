...
def plot_join(join_grid, join_oc, participants_n):
    ...
    want_illegible = np.array([participants_n-join_grid,
                            participants_n-join_oc])
...
# import the data
df_grid, df_oc = importData('AMT.xls', 239, 'A:BZ')
df_ref_grid, df_ref_oc = importData('Survey_Qs_fairness.xlsx', 5, 'A:I')
...
def main():
    ...
    participants_n = np.size(grid_parts[0][col_sc[0:3]].to_numpy())
