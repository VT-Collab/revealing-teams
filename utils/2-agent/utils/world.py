...
def envGoals():
    ...
    goal2 = Object((0.4, 0.9), [100, 100, 100], 50)
    goals = [goal1, goal2]
    # each agent's goal options
    agent1_goal = [list(goal1.state), list(goal2.state)]#, list(agent1.state)]
    agent2_goal = [list(goal1.state), list(goal2.state)]#, list(agent2.state)]
